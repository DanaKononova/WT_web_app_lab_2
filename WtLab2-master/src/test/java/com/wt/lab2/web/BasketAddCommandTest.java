...
import com.wt.lab2.web.commands.commandImpl.CartAddCommand;
...
public class BasketAddCommandTest {
    ...
    @Test
    void execute_AddToCart_Success() throws CommandException, ServiceException {
