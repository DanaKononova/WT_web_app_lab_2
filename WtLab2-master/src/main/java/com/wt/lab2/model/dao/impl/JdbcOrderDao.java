...
import com.wt.lab2.model.entities.order.OrdersExtractor;
...
public class JdbcOrderDao implements OrderDao {
    ...
    private static final String SAVE_ORDER = "INSERT INTO orders (secureID, subtotal, deliveryPrice, " +
            "totalPrice, firstName, lastName, deliveryAddress, contactcarNo, additionalInformation, date, time, login) " +
            "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    /**
